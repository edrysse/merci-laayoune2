...
@endphp
    ...
    <section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url({{ secure_url('clientpage/images/bg-event-03.jpg') }});">
    ...
    <section class="py-5">
         @if ($msg = Session::get('msg'))
            <div class="alert alert-success">
                {{ $msg }}
                <div>
                    <a href="{{ secure_url(route('clientMenu.index')) }}">
                        <button class="btn btn-success flex-shrink-0" type="submit">
                            <i class="bi-cart-fill me-1"></i>
                            retour au menu
                        </button>
                    </a>
                    <a href="{{ secure_url(route('pannier.index')) }}">
                        <button class="btn btn-success flex-shrink-0" type="submit">
                            <i class="bi-cart-fill me-1"></i>
                            aller au panier
                        </button>
        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="{{ secure_url($repas->image) }}" alt="..." /></div>
                <div class="col-md-6">
